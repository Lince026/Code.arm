...
void loop() {
  ...
  else if (state == 'L') { // Se o estado recebido for igual a 'B', o carro se movimenta para trás.
  ...
  else if (state == 'B') {   // Se o estado recebido for igual a 'L', o carro se movimenta para esquerda.
    digitalWrite(motorA1, 0);
    digitalWrite(motorA2, vSpeed);
    digitalWrite(motorB1, vSpeed);
    digitalWrite(motorB2, 0);
